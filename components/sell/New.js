  ...
  render() {
    return (
      <View style={styles.main_wrapper} >
        ...
        <TouchableOpacity style={[styles.photo_background_hotspot, {display: this.state.photo_select_display}]} ></TouchableOpacity>
        <View style={[styles.new_photo_chose_wrapper, {display: this.state.photo_select_display}]} >
