  ...
  render() {
    return (
      <View style={styles.main_wrapper} >
        <Image source={require('./../../assets/register_logo.png')} style={styles.top} ></Image>
        ...
        <View style={{zIndex: 5, height: 50, marginTop: 20, overflow: "visible", marginLeft: 40, marginRight: 40}} >
